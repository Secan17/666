...
try:
    ...
    with col1:
        ...
        st.markdown("<h1 style='color: darkblue;font-size: 30px;'>Domestic students result:</h1>", unsafe_allow_html=True)
        
        if prediction[0] == 1:
            st.markdown(f"<h2 style='color: darkblue;font-size: 28px;'> Dropout！</h2>", unsafe_allow_html=True)
        elif prediction[0] == 0:
            st.markdown(f"<h2 style='color: darkblue;font-size: 28px; '>Graduate！</h2>", unsafe_allow_html=True)
    ...
    with col3:
        ...
        if 2 <= Nationality <= 21:
            ...
            st.markdown("<h1 style='color: darkblue; font-size: 30px;'>International students result:</h1>", unsafe_allow_html=True)
